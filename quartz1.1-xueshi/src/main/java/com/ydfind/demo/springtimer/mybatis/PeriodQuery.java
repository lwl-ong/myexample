...
public class PeriodQuery {
    ...
    private long ms;
    private static org.slf4j.Logger logger = LoggerFactory.getLogger(PeriodQuery.class);
    public void queryByDate() throws IOException {
        ...
        //执行SQL
        List<Object> userList = sqlSession.selectList("test.queryUserByDate");
        ...
        //设置表头信息
        String sheetTitle = "杭州学时报表" + datenum.substring(0,8);
        String[] title = {"日期", "总学时","无效总学时"};
