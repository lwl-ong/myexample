...
public class C1ChangeC2 {

    //日期号
    private static String datenum;
    private static String datenumstart;
    private long ms;
    private static org.slf4j.Logger logger = LoggerFactory.getLogger(C1ChangeC2.class);
    public void queryC1ChangeC2() throws IOException {
        ...
        //执行SQL
        List<Object> userList = sqlSession.selectList("test.queryC1ChangeC2");
        ...
        //设置表头信息
        String sheetTitle = "C1转C2" + datenum.substring(0,8);
        String[] title = {"驾校","数量"};
