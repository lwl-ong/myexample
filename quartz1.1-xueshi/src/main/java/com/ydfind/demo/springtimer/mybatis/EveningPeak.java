...
public class EveningPeak {

    //日期号
    private static String datenum;
    private static String datenumstart;
    private long ms;
    private static org.slf4j.Logger logger = LoggerFactory.getLogger(EveningPeak.class);
    public void queryEveningPeak() throws IOException {
        ...
        //执行SQL
        List<Object> userList = sqlSession.selectList("test.queryEveningPeak");
        ...
        //设置表头信息
        String sheetTitle = "晚高峰训练" + datenum.substring(0,8);
